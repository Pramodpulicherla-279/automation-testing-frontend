    ...
    <header className="app-header">
      ...
      <div className="status-cont">
        ...
        <button
          ...
          disabled={uiIssuesLoading || uiIssuesDisabled}
          className="view-UI-button"
          title={
            uiIssuesDisabled ? 'Unavailable while a test run is in progress'
              : uiIssuesOpen ? 'Close UI Screenshot Issues'
              : 'Open UI Screenshot Issues'
          }
          style={{
            ...(uiIssuesOpen ? {
              background: '#EFF6FF',
            ...
            ...(uiIssuesDisabled ? { opacity: 0.5, cursor: 'not-allowed' } : {}),
          }}
        >
