...
const NetworkConfig = ({ setNetworkConfig, isRunning = false }) => {
    ...
    const handleApply = async () => {
        ...
        try {
            const res = await fetch(`${API_BASE_URL}/network-simulate/apply`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className="network-card">
            ...
            <div className={`config-body ${!enabled || isRunning ? "disabled-state" : ""}`}>
                ...
                <details className="advanced-settings">
                    ...
                    <div className="advanced-content">
                        <div className="slider-group">
                            ...
                            <input type="range" min="0.1" max="100" step="0.1" value={download} onChange={(e) => setDownload(e.target.value)} disabled={!enabled || isRunning} />
                        </div>
                        ...
                        <div className="slider-group">
                            ...
                            <input type="range" min="0.05" max="50" step="0.1" value={upload} onChange={(e) => setUpload(e.target.value)} disabled={!enabled || isRunning} />
                        </div>
                        ...
                        <div className="slider-group">
                            ...
                            <input type="range" min="0" max="1000" step="10" value={latency} onChange={(e) => setLatency(e.target.value)} disabled={!enabled || isRunning} />
                        </div>
                        ...
                        <div className="slider-group">
                            ...
                            <input type="range" min="0" max="10" step="0.1" value={packetLoss} onChange={(e) => setPacketLoss(e.target.value)} disabled={!enabled || isRunning} />
                        </div>
                        ...
                        <div className="slider-group">
                            ...
                            <input type="range" min="0" max="200" step="5" value={jitter} onChange={(e) => setJitter(e.target.value)} disabled={!enabled || isRunning} />
                        </div>
                    </div>
                </details>
            </div>
            ...
            {/* Apply */}
            <button className="btn-primary" disabled={!enabled || isRunning} onClick={handleApply}>
                Apply Configuration
            </button>
        </div>
    );
